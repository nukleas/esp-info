...
export const esp32s2Pins = [
  ...
  { pin: 11, name: 'GPIO8', type: 'gpio', voltage: '3.3V', description: 'ADC1 CH7 / Touch8 / SDA', alternateFunctions: ['ADC1_CH7', 'TOUCH8', 'RTC_GPIO8'], notes: 'Default I2C SDA. ADC and touch capable.', category: ['gpio', 'adc', 'touch', 'i2c', 'pwm'], defaultFunction: 'SDA', side: 'left' },
  { pin: 12, name: 'GPIO9', type: 'gpio', voltage: '3.3V', description: 'ADC1 CH8 / Touch9 / SCL', alternateFunctions: ['ADC1_CH8', 'TOUCH9', 'RTC_GPIO9', 'FSPIHD'], notes: 'Default I2C SCL. ADC, touch, and SPI capable.', category: ['gpio', 'adc', 'touch', 'i2c', 'spi', 'pwm'], defaultFunction: 'SCL', side: 'left' },
